...
class MFMPHRDepthNet(NetworkBase):
    """
    ...
    def __init__(self, image_extractor_name, image_extractor_hparams, lidar_extractor_name, lidar_extractor_hparams,
        ...
        num_ch_skips = get_ch_post_fusion(self.fusion_name, self.lidar_ch_enc, self.num_ch_enc)
        ...
        self.decoder = HRDepthDecoder(chans_enc=num_ch_skips, **decoder_hparams)
